...
const FVGameteImageView = ({isEgg, chromosomes=[], id, className, style, displayStyle, onClick}) => {
  ...
  const defaultImageWidth = 150,
        ...
        fillColor = displayStyle && displayStyle.fillColor ? displayStyle.fillColor : '#fff';
